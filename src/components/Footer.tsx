...
export default function Footer() {
  return (
    <footer className="bg-[#040480] text-white py-16">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="w-full mb-16">
          <div className="max-w-2xl">
            <img 
              ...
              alt="MAZ Moves" 
              className="h-20 bg-white p-2 rounded-lg w-fit mb-8 hover:scale-105 transition-transform" 
            />
        ...
        <Separator className="mb-16 bg-white/20" />
        
        {/* Three Column Grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {/* Navigation Links */}
          <Card className="bg-white/5 border-none text-left">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold mb-8 text-white">Quick Links</h3>
              <div className="flex flex-col gap-4">
                <Link to="/" className="text-lg text-gray-300 hover:text-[#84d21f] transition-colors">
                  Home
                </Link>
                <Link to="/services" className="text-lg text-gray-300 hover:text-[#84d21f] transition-colors">
                  Services
                </Link>
                <Link to="/about" className="text-lg text-gray-300 hover:text-[#84d21f] transition-colors">
                  About Us
                </Link>
                <Link to="/companies" className="text-lg text-gray-300 hover:text-[#84d21f] transition-colors">
                  Partner With Us
                </Link>
              </div>
            </CardContent>
          ...
          <Card className="bg-white/5 border-none text-left">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold mb-8 text-white">Legal</h3>
              <div className="flex flex-col gap-4">
                <Link to="/terms-and-conditions" className="text-lg text-gray-300 hover:text-[#84d21f] transition-colors">
                  Terms & Conditions
                </Link>
                <Link to="/privacy-policy" className="text-lg text-gray-300 hover:text-[#84d21f] transition-colors">
                  Privacy Policy
                </Link>
              </div>
            </CardContent>
        ...
        {/* Copyright */}
        <Separator className="mt-16 mb-8 bg-white/20" />
