...
export default function Footer() {
  return (
    <footer className="bg-[#040480] text-white py-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          {/* Quick Links */}
          <div className="flex flex-col items-start">
            <h3 className="text-xs font-medium mb-2 text-gray-300">Quick Links</h3>
          ...
          {/* Legal */}
          <div className="flex flex-col items-start">
            <h3 className="text-xs font-medium mb-2 text-gray-300">Legal</h3>
            <div className="flex flex-col space-y-1.5">
          ...
          {/* Contact */}
          <div className="flex flex-col items-start">
            <h3 className="text-xs font-medium mb-2 text-gray-300">Contact Us</h3>
            <div className="flex flex-col space-y-1.5">
              <a 
