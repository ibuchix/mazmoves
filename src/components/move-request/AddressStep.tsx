  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        {isGeocoding && (
          <div className="flex items-center text-sm text-brand-slateLight">
      ...
      <div className="grid gap-4">
        <div className="space-y-2">
          <Label htmlFor={`${type}-street`} className="text-sm font-medium text-brand-slate">
            Street Address
        ...
        <div className="space-y-2">
          <Label htmlFor={`${type}-city`} className="text-sm font-medium text-brand-slate">
            City
            <span className="text-red-500 ml-1">*</span>
          </Label>
          <Input
        ...
        {isInternational && (
          <div className="space-y-2">
            <Label htmlFor={`${type}-country`} className="text-sm font-medium text-brand-slate">
              Country
              <span className="text-red-500 ml-1">*</span>
            </Label>
            <Input
        ...
        <div className="space-y-2">
          <Label htmlFor={`${type}-zipCode`} className="text-sm font-medium text-brand-slate">
            Postal Code
            <span className="text-red-500 ml-1">*</span>
          </Label>
          <Input
